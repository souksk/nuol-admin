...
function TeacherAddConfirm({
  ...
  const _confirmTeacherAdd = async () => {
    ...
    // //console.log(param)
    await createUser({ variables: param })
            ...
            <div style={{ width: '80%', marginLeft: 'auto', marginRight: 'auto' }}>
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                >
                  ...
                  <Col sm='8' style={{marginTop: 8}}>
                    <span>
                      {param.data && param.data.firstname}{' '}
                    </span>
                  </Col>
                </Form.Group>
                ...
                >
                  ...
                  <Col sm='8' style={{marginTop: 8}}>
                    <span>
                      {param.data && param.data.lastname}
                    </span>
                  </Col>
                </Form.Group>
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                >
                  ...
                  <Col sm='8' style={{marginTop: 8}}>
                    <span>
                      {param.data && param.data.password}
                    </span>
                  </Col>
                </Form.Group>
              </div>
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                >
                  ...
                  <Col sm='8' style={{marginTop: 8}}>
                    <span>
                      {param.data && param.data.description}
                    </span>
                  </Col>
                </Form.Group>
